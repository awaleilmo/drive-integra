...
<template>
      ...
      <div v-show="active" class="rounded-lg overflow-hidden transform transition-all sm:w-full sm:mx-auto">
        <div v-if="active"
          ...
          <ul>
            ...
            <li>
              <a>
                <iconify icon="solar:move-to-folder-bold-duotone" class="text-orange-500 dark:text-blue-600"
                  height="1.8em" />
  ...
  <Modal :show="folderModal.open" @close="closeFolderModal" maxWidth="sm">
    <div class="py-6 px-6 form-control">
      ...
      <input @keyup.enter="folderSave" id="inputFolderName" type="text" placeholder="Nama Folder"
        v-model="folderModal.name" autofocus class="input input-bordered w-full mt-5" />
